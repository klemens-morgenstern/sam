...
template struct basic_barrier<st, BOOST_ASEM_ASIO_NAMESPACE::any_io_executor >;
template struct basic_condition_variable<st, BOOST_ASEM_ASIO_NAMESPACE::any_io_executor >;
