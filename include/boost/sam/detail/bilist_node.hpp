...
#ifndef BOOST_SAM_DETAIL_BILIST_NODE_HPP
#define BOOST_SAM_DETAIL_BILIST_NODE_HPP
...
struct bilist_node
{
  ...
  bilist_node &operator=(bilist_node const &) = delete;
  ...
  // for the root node
  bilist_node(bilist_node &&lhs) noexcept : next_(lhs.next_), prev_(lhs.prev_)
  {
    lhs.next_ = &lhs;
    lhs.prev_ = &lhs;
