...
def main(ctx):
    ...
    return [
        ...
        linux("clang",          branch, "docker.io/silkeh/clang", toolset='clang', variant="release", cxxstd="11,14,17,20", stdlib="libc++"),
        linux("clang (asan)",   branch, "docker.io/silkeh/clang", toolset='clang', variant="release", cxxstd="11,20", address_sanitizer="on"),
        linux("clang (tsan)",   branch, "docker.io/silkeh/clang", toolset='clang', variant="release", cxxstd="11,20", thread_sanitizer="on"),
